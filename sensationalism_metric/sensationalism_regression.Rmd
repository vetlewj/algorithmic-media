...
```{r}
stargazer(model_log, type='latex', notes = c('Log interpretation: coef * 100 is relative change in score', 'for 1%-point change in sensationalism score.', 'Filtered for score > 1.'), 
