...
data[, jargon_interval := cut(jargon_percentage_times_100, breaks = seq(5, 100, by = 15))]
data[is.na(jargon_interval), jargon_interval := '(0,5]']
# order by jargon_prop times 100
model_interaction_intervals = lm(
  log(score) ~ factor(jargon_interval, levels = c('(0,5]', '(5,20]', '(20,35]', '(35,50]', '(50,65]', '(65,80]')):jargon_percentage_times_100 +
    factor(year) +
    factor(month) +
    factor(label_voting_manual) + 
    factor(jargon_interval, levels = c('(0,5]', '(5,20]', '(20,35]', '(35,50]', '(50,65]', '(65,80]')), data = data[score> 1 & jargon_proportion  > 0 & label_voting_manual %in% c('repo', 'scientific', 'news', 'social_media', 'scam'),]
)
stargazer(model_interaction_intervals, type = "text", 
          notes = c(
            'Filtered for score > 1 and repo, scientific, news, social media and scam domains.'
          )
          ,omit=1:21
          , covariate.labels = c('(5,20]', '(20,35]', '(35,50]', '(50,65]', '(65,80]', 'Jargon x (0,5]', 'Jargon x (5,20]', 'Jargon x (20,35]', 'Jargon x (35,50]', 'Jargon x (50,65]', 'Jargon x (65,80]')
          )
